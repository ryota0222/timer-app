...
import {
  addCategory,
  getData as getDataOfCategories,
...
export default function DetailScreen() {
  ...
  useEffect(() => {
    if (timer) {
      setHour(Math.floor((timer.seconds || 0) / 60 / 60));
      setMinute(Math.floor((timer.seconds || 0) / 60) % 60);
      setSecond((timer.seconds || 0) % 60);
      onChangeName(timer.title || "");
      setCategory(timer.category || null);
      setPendingCategory(timer.category || null);
